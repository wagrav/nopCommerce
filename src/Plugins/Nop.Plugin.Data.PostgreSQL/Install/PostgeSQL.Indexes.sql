...
CREATE INDEX "IX_Log_CreatedOnUtc" ON "Log" ("CreatedOnUtc" DESC);
...
CREATE INDEX "IX_PCM_ProductId_Extended" ON "Product_Category_Mapping" ("ProductId" ASC, "IsFeaturedProduct" ASC); -- INCLUDE ("CategoryId");
CREATE INDEX "IX_PMM_Product_and_Manufacturer" ON "Product_Manufacturer_Mapping" ("ManufacturerId" ASC, "ProductId" ASC);
CREATE INDEX "IX_PMM_ProductId_Extended" ON "Product_Manufacturer_Mapping" ("ProductId" ASC, "IsFeaturedProduct" ASC); --INCLUDE ("ManufacturerId");
...
CREATE INDEX "IX_QueuedEmail_SentOnUtc_DontSendBeforeDateUtc_Extended" ON "QueuedEmail" ("SentOnUtc", "DontSendBeforeDateUtc"); --INCLUDE ("SentTries");
CREATE INDEX "IX_Product_VisibleIndividually_Published_Deleted_Extended" ON "Product" ("VisibleIndividually","Published","Deleted"); --INCLUDE ("Id","AvailableStartDateTimeUtc","AvailableEndDateTimeUtc");
CREATE INDEX "IX_Category_Deleted_Extended" ON "Category" ("Deleted"); --INCLUDE ("Id","Name","SubjectToAcl","LimitedToStores","Published");